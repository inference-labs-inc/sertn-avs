...
// Source: github.com/inference-labs-inc/sertn-avs/core/chainio (interfaces: AvsReaderer)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/avs_reader.go -package=mocks github.com/inference-labs-inc/sertn-avs/core/chainio AvsReaderer
//
...
import (
	...
	contractERC20Mock "github.com/inference-labs-inc/sertn-avs/contracts/bindings/ERC20Mock"
...
func (m *MockAvsReaderer) CheckSignatures(arg0 context.Context, arg1 [32]byte, arg2 []byte, arg3 uint32, arg4 contractSertnTaskManager.IBLSSignatureCheckerNonSignerStakesAndSignature) (contractSertnTaskManager.IBLSSignatureCheckerQuorumStakeTotals, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckSignatures", arg0, arg1, arg2, arg3, arg4)
	ret0, _ := ret[0].(contractSertnTaskManager.IBLSSignatureCheckerQuorumStakeTotals)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
