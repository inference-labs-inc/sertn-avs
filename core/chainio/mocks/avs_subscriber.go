...
// Source: github.com/inference-labs-inc/sertn-avs/core/chainio (interfaces: AvsSubscriberer)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/avs_subscriber.go -package=mocks github.com/inference-labs-inc/sertn-avs/core/chainio AvsSubscriberer
//
...
func (m *MockAvsSubscriberer) ParseTaskResponded(arg0 types.Log) (*contractSertnTaskManager.ContractSertnTaskManagerTaskResponded, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ParseTaskResponded", arg0)
	ret0, _ := ret[0].(*contractSertnTaskManager.ContractSertnTaskManagerTaskResponded)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAvsSubscriberer) SubscribeToNewTasks(arg0 chan *contractSertnTaskManager.ContractSertnTaskManagerNewTaskCreated) event.Subscription {
	m.ctrl.T.Helper()
...
func (m *MockAvsSubscriberer) SubscribeToTaskChallenge(arg0 chan *contractSertnTaskManager.ContractSertnTaskManagerTaskChallenged) event.Subscription {
	m.ctrl.T.Helper()
...
func (m *MockAvsSubscriberer) SubscribeToTaskResponses(arg0 chan *contractSertnTaskManager.ContractSertnTaskManagerTaskResponded) event.Subscription {
	m.ctrl.T.Helper()
