...
//             address(sertnServiceManager)
//         );
//         ISertnServiceManager.Model[]
//             memory _model = new ISertnServiceManager.Model[](1);
...
//             memory _operatorModel = new ISertnServiceManager.[](1);
...
//         vm.startPrank(_user);
//         ISertnServiceManager.TaskResponse memory _taskResponse = abi.decode(
...
//     function _addModel(
//         address _operator,
//         ISertnServiceManager.Model[] memory _models,
